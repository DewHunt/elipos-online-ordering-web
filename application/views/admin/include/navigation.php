    ...
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?= base_url('admin/dashboard') ?>" class="site_title">
                <i class="fa fa-paw"></i>&nbsp;<span><?= get_company_name() ?></span>
            </a>
        </div>
        ...
        <div class="profile clearfix">
            <div class="profile_pic">
                <img src="<?= base_url('assets/my_design/admin_design/images/user.png') ?>" alt="..." class="img-circle profile_img">
            </div>
        ...
        <div class="sidebar-footer hidden-small">
            <?php
                $setting_url = 'javascript:void()';
                if ($user_role_id == 1) {
                    $setting_url = base_url('admin/settings');
                }
            ?>
            <a href="<?= $setting_url ?>" data-toggle="tooltip" data-placement="top" title="Settings">
