    ...
    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 col-12 mb-2">
        <div class="progress-container">
            ...
            <div class="progress-body">
                <div class="progress">
                    <div class="progress-bar" style="width: <?= $fiveStarAvg ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="progress-container">
            ...
            <div class="progress-body">
                <div class="progress">
                    <div class="progress-bar" style="width: <?= $fourStarAvg ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="progress-container">
            ...
            <div class="progress-body">
                <div class="progress">
                    <div class="progress-bar" style="width: <?= $threeStarAvg ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="progress-container">
            ...
            <div class="progress-body">
                <div class="progress">
                    <div class="progress-bar" style="width: <?= $twoStarAvg ?>%"></div>
                </div>
            </div>
        </div>
        ...
        <div class="progress-container">
            ...
            <div class="progress-body">
                <div class="progress">
                    <div class="progress-bar" style="width: <?= $oneStarAvg ?>%"></div>
                </div>
            </div>
        </div>
    </div>
