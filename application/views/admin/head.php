    ...
    <link href="<?= base_url('assets/multi_selectable_tree_structure/jquery.tree-multiselect.min.css') ?>" rel="stylesheet">

    <!-- Bootstrap -->
    <link href="<?= base_url('assets/admin/theme/vendors/bootstrap/dist/css/bootstrap.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/admin/css/animate.min.css') ?>" rel="stylesheet">
    <!-- Font Awesome -->
    <!--<link href="<? /*= base_url('assets/admin/theme/vendors/font-awesome/css/font-awesome.min.css') */ ?>" rel="stylesheet">-->

    <link href="//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css" rel="stylesheet">
    <!-- NProgress -->
    <link href="<?= base_url('assets/admin/theme/vendors/nprogress/nprogress.css') ?>" rel="stylesheet">
    <!-- jQuery custom content scroller -->
    <link href="<?= base_url('assets/admin/theme/vendors/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css') ?>" rel="stylesheet"/>

    <!-- Custom Theme Style -->
    <link href="<?= base_url('assets/admin/theme/build/css/custom.min.css') ?>" rel="stylesheet">
    <link type="text/css" href="<?= base_url('assets/admin/css/style.css') ?>" rel="stylesheet"/>
    ...
    <!--code edit start-->
    <link href="<?= base_url('assets/admin/theme/vendors/iCheck/skins/flat/green.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/admin/theme/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/admin/theme/vendors/jqvmap/dist/jqvmap.min.css') ?>" rel="stylesheet">
    <!-- <link href="<? base_url('assets/admin/theme/vendors/bootstrap-daterangepicker/daterangepicker.css') ?>" rel="stylesheet"> -->
    <link href="<?= base_url('assets/admin/theme/vendors/bootstrap-daterangepicker/daterangepicker.scss') ?>" rel="stylesheet">
    ...
    <!-- Multi Selectable Tree Structure -->
    <script src="<?= base_url('assets/multi_selectable_tree_structure/jquery.tree-multiselect.js') ?>"></script>
