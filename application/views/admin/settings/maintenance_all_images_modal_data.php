<style type="text/css" -->>
    ...
    .btn-refresh { font-size: 16px; font-weight: bold; color: #8092a5; background-color: #f9f9f9; padding: 5px 35px; border: 1px solid #fbf9f9; 
        border-radius: 3px; }
...
<form class="form-horizontal" id="galleryImageForm" action="<?= base_url('admin/settings/maintenance_settings_images_upload'); ?>" method="POST" enctype="multipart/form-data" name="form">
    <div class="row">
		...
		<ul>
			...
			<?php foreach ($images as $file_name): ?>
				...
				<li class="text-center">
					<input type="checkbox" id="cb<?= $count ?>" class="image-name" name="image_name" value="<?= $file_name ?>"/>
