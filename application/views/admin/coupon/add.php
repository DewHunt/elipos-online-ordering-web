<div class="panel panel-default">
    ...
    <?php
        ...
        $coupon = (!empty($formData)) ? (object)$formData : null;
    ?>

    <div class="panel-body">
        <form id="coupon-form" method="post" action="<?= base_url('admin/coupons/save') ?>">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <label for="code">Code</label>
                    <div class=" form-group">
                        <input type="text" class="form-control" pattern=".{6,}" required title="6 alpha numeric minimum" id="code" name="code" value="<?= get_property_value('code', $coupon); ?>">
                    </div>
                </div>
                    ...
                    <div class=" form-group">
                        <div id="reportrange-new" class="pull-right calender-block">
                            ...
                            <div class="date-to-form">
                                ...
                                <input id="to_date" type="hidden" name="expired_date" value="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    ...
                    <div class=" form-group">
                        <input type="number" min="1" class="form-control" name="remaining_usages" id="remaining_usages" value="<?= get_property_value('remaining_usages',$coupon,1); ?>">
                    </div>
                </div>
