<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form action="<?=base_url('admin/subscriber/insert')?>" method="post">
            <div class="row">
                <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                    <div class="form-group">
                        <label for="email-address">Email Address</label>
                        <input type="email" class="form-control" placeholder="Email" name="email" value="<?=get_array_key_value('email',get_flash_form_data())?>">
                    </div>
                </div>
