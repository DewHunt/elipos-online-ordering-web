<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form id="add_table_form" action="<?= base_url('admin/table/save') ?>" method="post">
        	<div class="row">
        		...
        		<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 text-right">
        			<button class="btn btn-primary btn-block" style="margin-top: 24px;"><i class="fa fa-save"></i>&nbsp;Save</button>
        		</div>
        	</div>
        </form>
    </div>
