...
<html lang="en">
    ...
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=484075842047418&ev=PageView&noscript=1"
                   /></noscript>
                            ...
                            <div class="">
                                <div class="container">
                                    <div data-aos="fade-left" class="agileits-banner-info">
                                        <!--<h3 class="height-top">Welcome to our</h3>-->
                                        <!--<h3>Restaurant</h3>-->
                                        <p></p>
    ...
    <div class="about" id="about">
        <div class="container">
            ...
            <p>The Streetly Balti was established in Streetly, Sutton Coldfield in September 1993. It was the formation of a partnership between three brothers Jamal, Imam, and Shab.
                ...
                <a  href="https://streetlybalti.co.uk/menu" class="btn btn-lg btn-primary" >Order Online &nbsp;&nbsp;<i class="fa fa-hand-o-up" ></i>
                </a>    
            </p>
        ...
        <div class="container">
            <div class="card" style="padding: .5rem;background: #FFFFFF;border: 3px solid black;border-radius: 0">
                <div class="text-center card-header">
                    <h3 class="tittle">Our Opening & Closing Hours</h3>
                </div>
<?php
$this->load->view('shop_opening_timing_list');
?>
            </div>
        </div>
    </div>
