        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                if(!empty($product->categoryId)){
                 ...
                 //   print_array($assigned_modifier);
                   // $assigned_modifier_by_category_id = $m_show_side_dish->get_assigned_modifier_by_category_id($product->categoryId) ;
...
<!--<script type="text/javascript">
    ...
    var modifierAsCategoryArray=Object.values(modifierAsCategory);
        $('#add_to_cart_form').on('submit', function (e) {
            ...
            $('.sub-product-modal .adding-to-cart-button-loader').css('display','block');
            $.ajax({
                type: "POST",
