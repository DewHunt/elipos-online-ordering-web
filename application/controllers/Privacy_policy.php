...
class Privacy_policy extends Frontend_Controller {
    ...
    public function index()
    {
        ...
        $page_details=$m_page_settings->get_by_name('privacy_policy');
        ...
        if(!empty($page_details)){
            if($page_details->is_show){
                ...
                $this->page_content= $this->load->view('privacy_policy/privacy_policy', $this->data,true);
    ...
    public function app()
    {
        ...
        if(!empty($page_details)){
            if($page_details->is_show){
                ...
                $this->load->view('privacy_policy/privacy_policy', $this->data);
